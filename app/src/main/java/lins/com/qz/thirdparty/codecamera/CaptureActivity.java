...
import lins.com.qz.thirdparty.codecamera.camera.CameraManager;
import lins.com.qz.thirdparty.codecamera.common.BitmapUtils;
import lins.com.qz.thirdparty.codecamera.decode.BitmapDecoder;
import lins.com.qz.thirdparty.codecamera.decode.CaptureActivityHandler;
import lins.com.qz.thirdparty.codecamera.view.ViewfinderView;
...
public final class CaptureActivity extends Activity implements
	...
	private PopupWindow mPopupWindow;	// PopupWindow窗体	
	private LinearLayout mHideLly;	// 隐藏的布局
	private ImageView mHideIv;	// 显示隐藏布局图标
	private ImageView mBackIv;	// 返回图片控件
	private TextView mBottomTv;	// 底部文本框
	private TextView mFlashTv;	// 闪光文本框
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mHideLly.findViewById(R.id.capture_scan_photo).setOnClickListener(this);
		mFlashTv = (TextView) mHideLly.findViewById(R.id.capture_flashlight);
...
//				Toast.LENGTH_SHORT).show();
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.tv_encodeQr:
				mPopupWindow.dismiss();
				Intent intent = new Intent(this, EncodeQrActivity.class);
				startActivity(intent);
				break;
